...
function initializeExam() {
    ...
    document.querySelectorAll(".circle").forEach(circle => {
        circle.addEventListener("click", function () {
            ...
            // একই প্রশ্নের জন্য আগের সিলেক্ট করা Circle আনসিলেক্ট করা
            this.parentElement.querySelectorAll(".circle").forEach(c => {
                c.classList.remove("selected");
                c.style.background = ""; // ব্যাকগ্রাউন্ড কালার রিসেট করা
                c.style.color = ""; // টেক্সট কালার রিসেট করা
            });

            // নতুন Circle সিলেক্ট করা
